...
//import org.apache.juddi.query.util.*; 

public class JuddiDeleteProcess{
  ...
  public static void main(String[] args) {
    ...
    if(juddiElems!=null){
       deleteBusiness(juddiProps,juddiElems);
    }
    System.out.println("Sfarsit");
  }
  
  public static void deleteBusiness(JuddiProperties juddiProps, JuddiElems juddiElems){
      ...
      if(foundList.getServiceInfos()!=null){
        if(foundList.getServiceInfos().getServiceInfo()!=null){
          ...
          for(ServiceInfo info:foundList.getServiceInfos().getServiceInfo()){
            ...
            deleteService.setAuthInfo(myPubAuthToken.getAuthInfo());
            deleteService.getServiceKey().add(info.getServiceKey());
